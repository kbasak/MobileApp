            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.fundAmount}>
                    <View>
                        ...
                        <Text style={{ fontSize: 27, fontFamily: 'sans-serif-condensed', fontWeight: '700', paddingVertical: 8 }}>${Secure_items.accountDetails[0].Balance}</Text>
                    </View>
                ...
                <View style={[styles.fundInterest, { minHeight: 60, marginTop: 0 }]}>
                    ...
                    <View style={{flexDirection:'row'}}>
                        <Text style={{ fontSize: 20, fontFamily: 'sans-serif-condensed', paddingHorizontal:10, paddingVertical:15 }}>$0</Text>
